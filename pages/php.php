...
<body>
		...
		<div class="container">
			...
			<nav id="menu">
				<ul>
					...
					<li class="current"><a href="php.php">PHP</a></li>
 				</ul>
				<ul>
		...
		<div class="container">
			...
			<div class="main-content">
				...
				<section class="posts-con">
					<article>
                                            <fieldset>
                                                <legend>Partie pratique:</legend>
                                                <label for="bio">votre script:</label>
                                                <textarea id="bio" name="script"></textarea>
                                            </fieldset>
                                            <button type="submit">Executer</button>
                                               ...
                                               <div class="res" style="  width: 440px;
  ...
  "> 
                                    ...
                                    <div style="display : block;background-color: #e8eeef;width: 440px;">
                                          <?php $script = $_POST["script"]; ?>
                                     <?php echo eval($script);?>
                                       </div>           
                                     </div>     
                                 </form>
